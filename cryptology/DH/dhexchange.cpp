...
static int INLINE _u128_is_odd(const uint128_t dq) { return dq.low & 1; }
...
void DH_generate_key_secret(DH_KEY secret_key, const DH_KEY my_private, 
	const DH_KEY another_public)
{
	uint128_t private_k;
	uint128_t another_k;
	uint128_t secret_k;
