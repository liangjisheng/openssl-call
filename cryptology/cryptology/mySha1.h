...
#ifndef _SELF_DEFINE_SHA1_H_
#define _SELF_DEFINE_SHA1_H_
...
class mySHA1
{
	public:
		mySHA1();
		virtual ~mySHA1();
		bool SHA_GO( const char *lpData_Input,int InputLen,char *lpSHACode_Output);
	private:
