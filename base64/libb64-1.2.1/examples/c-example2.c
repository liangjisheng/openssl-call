...
int main(int argc, char** argv)
{
	...
	char *inFileName = "test1.jpg";
	char *outFileName = "test1_encode.txt";
	char *decodeFileName = "test1_decode.jpg";
	inputFile   = fopen(inFileName, "rb");
	encodedFile = fopen(outFileName, "wb");
	...
	encodedFile = fopen(outFileName, "rb");
	decodedFile = fopen(decodeFileName, "wb");
